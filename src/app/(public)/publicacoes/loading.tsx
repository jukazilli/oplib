export default function PublicationsLoading() {
  return (
    ...
    >
      ...
      <div aria-hidden="true" className="h-12 w-56 rounded bg-muted" />
      <div aria-hidden="true" className="mt-8 h-48 rounded-card bg-muted" />
      <div aria-hidden="true" className="mt-8 grid gap-5 md:grid-cols-3">
        {[0, 1, 2].map((item) => (
