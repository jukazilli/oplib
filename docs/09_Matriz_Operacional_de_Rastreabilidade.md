...
| MED-001 | D02 §8.4; D05 §19; D07 §19                 | enviar, substituir e remover capa                           | `src/modules/media/`, componentes de upload                    | ciclo completo com validação, alt, substituição, remoção e limpeza de órfãos                            | `TEST-MED-001-*` | `docs/evidence/EVID-MED-001-01.md` | `review`  |
