...
| PUB-004 | D05 §§15–16; D07 §§11,18                   | publicar e atualizar atomicamente                           | `src/app/admin/publicacoes/actions.ts`, `src/modules/publishing/draft-repository.ts`, composer e invalidação de paths | falso conflito temporal corrigido e publicação real disponível; atualização autenticada, concorrência e rollback ainda exigem prova | `TEST-PUB-004-*` | `docs/evidence/EVID-PUB-004-01.md` | `in-progress` |
