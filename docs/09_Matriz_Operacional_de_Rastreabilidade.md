...
| AUTH-002 | D05 §10; D07 §16; TL §8  | proteger sessão, rotas e comandos                   | `src/proxy.ts`, `src/modules/identity/authorization.ts`       | Proxy e recursos protegidos; matriz negativa aprovada; aceite de expiração pendente | `TEST-AUTH-002-*` | `docs/evidence/EVID-AUTH-002-01.md` | `in-progress` |
