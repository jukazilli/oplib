...
| AUD-001 | D02 §11; D07 §§10,16; D06 §13              | registrar eventos administrativos mínimos                   | `src/modules/identity/audit/`, schema/migration                | matriz, writer e migration implementados; prova em banco pendente                                       | `TEST-AUD-001-*` | `docs/evidence/EVID-AUD-001-01.md` | `review`  |
