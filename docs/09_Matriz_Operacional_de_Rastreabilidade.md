...
| FND-016 | TL §26; INF §§25–26              | executar aceite integrado da Fundação         | `docs/tasks/FND-016.md`, `docs/evidence/EVID-FND-016-01.md`                   | auditoria de prontidão em execução                                                                           | `TEST-FND-016-01`                    | `docs/evidence/EVID-FND-016-01.md` | `in-progress` |
