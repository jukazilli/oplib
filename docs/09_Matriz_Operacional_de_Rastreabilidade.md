...
Esta matriz começou antes da implementação e hoje acompanha o estado real do repositório. Por isso:

- “Destino previsto” preserva a fronteira canônica do item;
- “Implementação atual” registra somente código, configuração ou decisão que já existe;
- testes listados continuam sendo contratos e seus resultados ficam nas evidências duráveis;
- evidências sem arquivo ou prova associada continuam esperadas, não concluídas;
- nenhum item recebe `done` por possuir apenas documentação ou deployment verde.
...
| ADM-001  | D04 §§20–23; D05 §§3,11  | criar shell e visão geral administrativa            | `src/app/admin/`, `src/components/admin/`, `src/modules/admin/`    | shell responsivo e visão geral real; aceite humano aprovado                            | `TEST-ADM-001-*`  | `docs/evidence/EVID-ADM-001-01.md`  | `done`    |
...
| ID      | Origem                                     | Requisito                                                   | Destino previsto                                                                                                         | Implementação atual                                                                                                                            | Testes previstos | Evidência esperada                 | Status        |
| ------- | ------------------------------------------ | ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------- | ---------------- | ---------------------------------- | ------------- |
| UX-002  | P-UX-018; D04 §24; D05 §12                 | definir contratos de interação editorial                    | `docs/decisions/UX-002.md`, referências e aceite                                                                         | decisão aprovada sem ressalvas; contratos reconciliados em D04/D05                                                                             | `TEST-UX-002-*`  | `docs/evidence/EVID-UX-002-01.md`  | `done`        |
| UX-003  | D04 §§20–22; D05 §§3,11,18; D07 §§10,16,30 | definir grafo operacional e direção de perfis               | `docs/decisions/UX-003.md`, referência e aceite                                                                          | proposta consolidada; código e rotas permanecem inalterados                                                                                    | `TEST-UX-003-*`  | `EVID-UX-003-01`                   | `review`      |
| TAX-001 | D02 §§8.1–8.3; D04 §6; D07 §§9.2,10        | criar áreas de conhecimento estáveis                        | `scripts/seed-knowledge-areas.mjs`, schema existente                                                                     | seed idempotente e integridade comprovados no Preview                                                                                          | `TEST-TAX-001-*` | `docs/evidence/EVID-TAX-001-01.md` | `done`        |
| TAX-002 | D02 §9; D05 §20; D07 §9.2                  | administrar categorias e tags                               | `src/modules/taxonomy/`, `src/app/admin/taxonomia/`                                                                      | CRUD, pesquisa, uso e exclusão transacional implementados                                                                                      | `TEST-TAX-002-*` | `docs/evidence/EVID-TAX-002-01.md` | `done`        |
| PUB-001 | D02 §§9–10; D05 §§12–13                    | criar e salvar rascunho manualmente                         | `src/modules/publishing/`, editor admin                                                                                  | fundação funcional aceita; evolução feed/modal vinculada a PUB-007                                                                             | `TEST-PUB-001-*` | `docs/evidence/EVID-PUB-001-01.md` | `done`        |
| PUB-002 | D02 §10; D05 §§13–14; D07 §12; TL §10      | editar e pré-visualizar Markdown seguro                     | `src/modules/publishing/markdown.ts`, `src/components/editor/`                                                           | renderer CommonMark/GFM compartilhado, sanitizado e integrado ao composer; Preview aceito                                                      | `TEST-PUB-002-*` | `docs/evidence/EVID-PUB-002-01.md` | `done`        |
| PUB-003 | D02 §§8.2–8.3; D05 §12; D07 §10            | manter metadados, referências e slug                        | `src/modules/publishing/`, composer                                                                                      | metadados e referências transacionais; slug normalizado, único e estável; Preview aceito                                                       | `TEST-PUB-003-*` | `docs/evidence/EVID-PUB-003-01.md` | `done`        |
| MED-001 | D02 §8.4; D05 §19; D07 §19                 | enviar, substituir e remover capa                           | `src/modules/media/`, componentes de upload                                                                              | ciclo completo com validação, alt, substituição, remoção e limpeza de órfãos                                                                   | `TEST-MED-001-*` | `docs/evidence/EVID-MED-001-01.md` | `done`        |
| PUB-004 | D05 §§15–16; D07 §§11,18                   | publicar e atualizar atomicamente                           | `src/app/admin/publicacoes/actions.ts`, `src/modules/publishing/draft-repository.ts`, composer, invalidação e drill Neon | publicação real disponível; atomicidade com auditoria, conflito e rollback comprovados no Preview; fluxo autenticado responsivo ainda pendente | `TEST-PUB-004-*` | `docs/evidence/EVID-PUB-004-01.md` | `in-progress` |
| PUB-005 | D05 §17; D07 §§11,18                       | retirar e republicar, invalidando cache                     | `src/modules/publishing/draft-repository.ts`, `src/app/admin/publicacoes/actions.ts`, lista editorial                    | transições transacionais, auditoria, cache e ações por estado implementadas; ciclo completo no Preview pendente                                | `TEST-PUB-005-*` | `docs/evidence/EVID-PUB-005-01.md` | `in-progress` |
| PUB-006 | D02 §§8.1,9; D04 §14; D07 §9.1             | definir destaque editorial                                  | `src/modules/publishing/`, home cache                                                                                    | comando auditado, UI e seleção pública determinística implementados; alteração editorial e reflexo público no Preview pendentes                | `TEST-PUB-006-*` | `docs/evidence/EVID-PUB-006-01.md` | `in-progress` |
| PUB-007 | D02 §9; D04 §§21–22; D05 §§11–12; UX-002   | listar publicações do proprietário e abrir composição modal | `src/app/admin/publicacoes/`, componentes editoriais                                                                     | lista privada, composer fluido, taxonomia/capa contextuais, menu, rascunhos e perfil aceitos no Preview                                        | `TEST-PUB-007-*` | `docs/evidence/EVID-PUB-007-01.md` | `done`        |
...
| AUD-001 | D02 §11; D07 §§10,16; D06 §13              | registrar eventos administrativos mínimos                   | `src/modules/identity/audit/`, schema/migration                                                                          | matriz, writer e migration em Preview; evento sintético confirmado com rollback                                                                | `TEST-AUD-001-*` | `docs/evidence/EVID-AUD-001-01.md` | `done`        |

## 9. Experiência pública e descoberta

| ID      | Origem                                  | Requisito                                      | Destino previsto                                                    | Implementação atual                                                                                                                       | Testes previstos | Evidência esperada                 | Status        |
| ------- | --------------------------------------- | ---------------------------------------------- | ------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- | ---------------- | ---------------------------------- | ------------- |
| WEB-001 | D04 §13; D05 §3; PUX 001–005            | criar shell público responsivo                 | `src/app/(public)/layout.tsx`, `src/components/editorial/`          | shell público aprovado no Preview em três breakpoints, axe, skip link e movimento reduzido; zoom e aceite humano pendentes                | `TEST-WEB-001-*` | `docs/evidence/EVID-WEB-001-01.md` | `in-progress` |
| WEB-002 | D02 §8.1; D04 §14; D05 §4               | criar página inicial editorial                 | `src/app/(public)/page.tsx`, `src/modules/discovery/`               | hero, busca, destaques, recentes e áreas implementados; shell aprovado no Preview, variedade editorial e aceite humano pendentes          | `TEST-WEB-002-*` | `docs/evidence/EVID-WEB-002-01.md` | `in-progress` |
| WEB-003 | D02 §§8.1–8.2; D05 §5; D07 §13          | implementar acervo, busca, filtros e paginação | `src/app/(public)/publicacoes/`, `src/modules/discovery/`           | acervo aprovado em três breakpoints, axe e Lighthouse; consulta real indexada medida, massa para paginação e combinações finais pendentes | `TEST-WEB-003-*` | `docs/evidence/EVID-WEB-003-01.md` | `in-progress` |
| WEB-004 | D02 §8.3; D04 §16; D05 §6               | criar página de leitura da publicação          | `src/app/(public)/publicacoes/[slug]/`, consulta pública e Markdown | publicação real aprovada em 320 px, canonical, comentários, axe e ausência segura de capa; demais estados, capa e breakpoints pendentes   | `TEST-WEB-004-*` | `docs/evidence/EVID-WEB-004-01.md` | `in-progress` |
| WEB-005 | D02 §12; D05 §7                         | compartilhar por recurso nativo ou copiar link | `src/components/editorial/share-action.tsx`                         | Web Share API, fallback clipboard, feedback e URL canônica implementados; navegador/dispositivo real e origem final pendentes             | `TEST-WEB-005-*` | `docs/evidence/EVID-WEB-005-01.md` | `in-progress` |
...
| SEO-001 | D02 §12; TL §17                         | gerar metadata, canonical e prévia social      | Metadata API nas rotas públicas                                     | política por ambiente, metadata global/dinâmica, canonical, capa e fallback social implementados                                          | `TEST-SEO-001-*` | `docs/evidence/EVID-SEO-001-01.md` | `in-progress` |
| SEO-002 | D02 §12; D07 §17; TL §17                | gerar sitemap, robots e dados estruturados     | `src/app/sitemap.ts`, `robots.ts`, JSON-LD                          | sitemap público, robots por ambiente, invalidação e Article JSON-LD implementados                                                         | `TEST-SEO-002-*` | `docs/evidence/EVID-SEO-002-01.md` | `in-progress` |

## 10. Interações e moderação

| ID       | Origem                            | Requisito                                 | Destino previsto                                            | Implementação atual                                                                                                             | Testes previstos  | Evidência esperada                  | Status        |
| -------- | --------------------------------- | ----------------------------------------- | ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- | ----------------- | ----------------------------------- | ------------- |
| LIKE-001 | D02 §8.5; D05 §8; D07 §14; TL §12 | curtir uma vez por navegador sem desfazer | `src/modules/interactions/likes/`, Route Handler, migration | cookie opaco, HMAC, inserção idempotente, contador autoritativo e UI implementados                                              | `TEST-LIKE-001-*` | `docs/evidence/EVID-LIKE-001-01.md` | `in-progress` |
| COM-001  | D02 §8.6; D05 §9; D07 §15; TL §12 | publicar e listar comentário imediato     | `src/modules/interactions/comments/`, Route Handler, UI     | persistência imediata, validação, proteção básica, UI e testes locais implementados; banco real, WAF, axe e navegador pendentes | `TEST-COM-001-*`  | `docs/evidence/EVID-COM-001-01.md`  | `in-progress` |
| MOD-001  | D02 §8.7; D04 §23; D05 §21        | consultar comentários na administração    | `src/app/admin/comentarios/`                                | lista autorizada, filtros, paginação e estados implementados; banco real, axe e aceite autenticado pendentes                    | `TEST-MOD-001-*`  | `docs/evidence/EVID-MOD-001-01.md`  | `in-progress` |
| MOD-002  | D02 §8.7; D05 §21; D07 §§11,15    | ocultar e restaurar comentário            | `src/modules/interactions/moderation/`                      | transições condicionais auditadas, ação autorizada e desfazer temporário implementados; concorrência e navegador real pendentes | `TEST-MOD-002-*`  | `docs/evidence/EVID-MOD-002-01.md`  | `in-progress` |
...
| ID       | Origem                                | Requisito                                 | Destino previsto                                         | Implementação atual                                                                                                                                            | Testes previstos  | Evidência esperada                  | Status          |
| -------- | ------------------------------------- | ----------------------------------------- | -------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- | ----------------------------------- | --------------- |
| UX-001   | PUX 008–011,016; D05 §§22–25          | completar estados, feedback e recuperação | componentes/fluxos afetados + E2E                        | matriz transversal e estados implementados/testados localmente; rede, sessão, tecnologia assistiva e aceite final permanecem no ledger                         | `TEST-UX-001-*`   | `docs/evidence/EVID-UX-001-01.md`   | `in-progress`   |
| QUAL-001 | PUX 012–013; D04 §§30–31; D05 §24     | validar acessibilidade e responsividade   | `tests/e2e/foundation.spec.ts`, checklist manual         | rotas públicas em três breakpoints e leitura real em 320 px aprovadas com axe; administração, zoom, teclado completo, leitor de tela e aceite humano pendentes | `TEST-QUAL-001-*` | `docs/evidence/EVID-QUAL-001-01.md` | `in-progress`   |
| QUAL-002 | D03 §9; D06 §17; D07 §§5,18,20        | validar desempenho e degradação segura    | testes de falha, Lighthouse e análise de bundle          | conteúdo real, consulta crítica indexada, degradação e baseline 96/96/95 com CLS 0 comprovados; Blob real, bundle final e dados de campo pendentes             | `TEST-QUAL-002-*` | `docs/evidence/EVID-QUAL-002-01.md` | `in-progress`   |
| SEC-001  | D02 §11; D06 §§14–15,18.4; D07 §24    | executar regressão de segurança           | testes unitários de segurança/rotas, CI, Vercel Firewall | corpus local e negativo no Preview aprovados e auditoria WAF saneada preparada; gate protegido, configuração ativa/draft e rate limits distribuídos pendentes  | `TEST-SEC-001-*`  | `docs/evidence/EVID-SEC-001-01.md`  | `in-progress`   |
...
| Gate              | Itens exigidos                                                                          | Evidência atual                               | Estado                                                  |
| ----------------- | --------------------------------------------------------------------------------------- | --------------------------------------------- | ------------------------------------------------------- |
| GATE-FND          | FND-001 a FND-016                                                                       | `docs/evidence/EVID-FND-016-01.md`            | aprovado para Development/Preview; Production bloqueada |
| GATE-EDITORIAL    | AUTH-001/002, ADM-001, UX-002, TAX-001, PUB-001–005/007, MED-001, AUD-001, WEB-001/004  | evidências individuais dos itens              | em andamento; PUB-004/005 e WEB-001/004 abertos         |
| GATE-DISCOVERY    | WEB-002/003/005, PUB-006, SEO-001/002                                                   | evidências individuais dos itens              | em andamento; nenhum item do gate está `done`           |
| GATE-INTERACTIONS | LIKE-001, COM-001, MOD-001–003, DEC-003                                                 | evidências individuais; MOD-003 ainda ausente | bloqueado por MOD-003 e DEC-003                         |
| GATE-MVP          | gates anteriores, ADM-002, WEB-006, UX-001, QUAL-001/002, SEC-001, CNT-001, DEC-002/004 | ainda sem evidência consolidada               | bloqueado pelos gates anteriores e decisões humanas     |
...
A aplicação executável, os ambientes Development/Preview e o núcleo editorial já existem. Dos 58 itens canônicos, 26 estão `done`; os demais preservam pendências de integração, Preview, aceite humano ou Production. A PR draft #48 concentra a regressão pública e de segurança mais recente.

`GATE-FND` está aprovado somente para Development e Preview por `OPS-002` e `EVID-FND-016-01`. Production continua bloqueada por FND-012, FND-015 e DEC-004, além dos demais gates do MVP.

No caminho crítico funcional, o próximo slice é concluir `PUB-004 — Publicar e atualizar`: registrar a publicação real já existente como prova parcial, validar atualização autenticada, idempotência, concorrência e rollback no Preview e fechar a evidência sem promover Production. Depois, seguir para `PUB-005`, pois retirada/republicação é necessária para comprovar cache, busca, leitura e sitemap antes de fechar os gates Editorial e Discovery.
