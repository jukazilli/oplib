...
| PUB-007 | D02 §9; D04 §§21–22; D05 §§11–12; UX-002   | listar publicações do proprietário e abrir composição modal | `src/app/admin/publicacoes/`, componentes editoriais | lista privada, box, modal, menu e biblioteca de rascunhos implementados | `TEST-PUB-007-*` | `docs/evidence/EVID-PUB-007-01.md` | `review`  |
