...
| PUB-007 | D02 §9; D04 §§21–22; D05 §§11–12; UX-002   | listar publicações do proprietário e abrir composição modal | `src/app/admin/publicacoes/`, componentes editoriais | fundação de criação e salvamento disponível em PUB-001       | `TEST-PUB-007-*` | `EVID-PUB-007-01`                  | `planned` |
