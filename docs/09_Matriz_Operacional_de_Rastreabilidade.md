...
| SEC-001  | D02 §11; D06 §§14–15,18.4; D07 §24    | executar regressão de segurança           | `tests/unit/security.test.ts`, rotas públicas, CI, Vercel Firewall | proveniência, payload de comentários e gate alto/crítico cobertos; corpus restante, alertas moderados, Preview e WAF pendentes | `TEST-SEC-001-*`  | `docs/evidence/EVID-SEC-001-01.md` | `in_progress`   |
