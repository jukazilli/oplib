...
| FND-005 | D07 §§22–23; TL §7; INF §§7–8,11 | provisionar Neon e branches em São Paulo | Neon + `docs/runbooks/neon.md` | projeto Neon em São Paulo, quatro branches persistentes e papéis segregados | `TEST-FND-005-01`, `TEST-FND-005-02` | `docs/evidence/EVID-FND-005-01.md` | `done` |
