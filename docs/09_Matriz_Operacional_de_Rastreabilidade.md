...
| PUB-002 | D02 §10; D05 §§13–14; D07 §12; TL §10      | editar e pré-visualizar Markdown seguro                     | `src/modules/publishing/markdown.ts`, `src/components/editor/` | renderer CommonMark/GFM compartilhado, sanitizado e integrado ao composer                               | `TEST-PUB-002-*` | `docs/evidence/EVID-PUB-002-01.md` | `review`  |
