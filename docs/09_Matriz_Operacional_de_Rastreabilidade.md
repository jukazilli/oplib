...
| TAX-001 | D02 §§8.1–8.3; D04 §6; D07 §§9.2,10   | criar áreas de conhecimento estáveis            | `scripts/seed-knowledge-areas.mjs`, schema existente        | seed idempotente e integridade comprovados no Preview     | `TEST-TAX-001-*` | `docs/evidence/EVID-TAX-001-01.md` | `review`        |
