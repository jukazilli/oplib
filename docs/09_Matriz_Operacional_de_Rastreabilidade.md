...
| ID      | Origem                                     | Requisito                                       | Destino previsto                                     | Implementação atual                                         | Testes previstos | Evidência esperada                 | Status    |
| ------- | ------------------------------------------ | ----------------------------------------------- | ---------------------------------------------------- | ----------------------------------------------------------- | ---------------- | ---------------------------------- | --------- |
| UX-002  | P-UX-018; D04 §24; D05 §12                 | definir contratos de interação editorial        | `docs/decisions/UX-002.md`, referências e aceite     | proposta consolidada; revisão do proprietário pendente      | `TEST-UX-002-*`  | `EVID-UX-002-01`                   | `review`  |
