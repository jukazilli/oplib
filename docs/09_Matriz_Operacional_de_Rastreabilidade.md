...
| FND-013 | D02 §11; D07 §24; INF §19        | aplicar baseline de segurança                 | `src/lib/security/`, headers, Vercel Firewall                                 | headers e payload aprovados no Preview; regra WAF em rascunho log                                            | `TEST-FND-013-*`                     | `docs/evidence/EVID-FND-013-01.md` | `in-progress` |
