...
| PUB-001 | D02 §§9–10; D05 §§12–13                    | criar e salvar rascunho manualmente             | `src/modules/publishing/`, editor admin              | rascunho incompleto, salvamento manual, recuperação e conflito implementados | `TEST-PUB-001-*` | `docs/evidence/EVID-PUB-001-01.md` | `review`  |
