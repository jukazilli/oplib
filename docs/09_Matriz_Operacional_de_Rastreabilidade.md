...
| FND-015 | D07 §23; INF §§14–15             | criar backup criptografado e provar restore   | PR #15 draft; `docs/decisions/OPS-002-foundation-development-exception.md`    | congelada; sem backup ou restore real; retomada obrigatória antes de Production                              | `TEST-FND-015-*`                     | `docs/evidence/EVID-FND-015-01.md` | `planned`     |
...
| ID      | Origem                                | Requisito                                       | Destino previsto                                     | Implementação atual                                       | Testes previstos | Evidência esperada                 | Status          |
| ------- | ------------------------------------- | ----------------------------------------------- | ---------------------------------------------------- | --------------------------------------------------------- | ---------------- | ---------------------------------- | --------------- |
| UX-002  | P-UX-018; D04 §24; D05 §12            | definir contratos de interação editorial        | documentação e protótipos aprovados                  | composição/lista aprovadas; controles internos pendentes  | `TEST-UX-002-*`  | `EVID-UX-002-01`                   | `blocked-human` |
