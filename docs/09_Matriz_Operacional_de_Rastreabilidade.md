...
| SEC-001  | D02 §11; D06 §§14–15,18.4; D07 §24    | executar regressão de segurança           | testes unitários de segurança/rotas, CI, Vercel Firewall | corpus local cobre proveniência, autorização negativa, payload, upload, conteúdo não confiável, SQL parametrizado, rate limit limitado, segredos e gate alto/crítico; alertas moderados, execução remota, Preview e WAF pendentes | `TEST-SEC-001-*`  | `docs/evidence/EVID-SEC-001-01.md` | `in_progress`   |
