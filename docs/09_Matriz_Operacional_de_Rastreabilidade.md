...
| PUB-003 | D02 §§8.2–8.3; D05 §12; D07 §10            | manter metadados, referências e slug                        | `src/modules/publishing/`, composer                            | metadados e referências transacionais; slug normalizado, único e estável                                | `TEST-PUB-003-*` | `docs/evidence/EVID-PUB-003-01.md` | `review`  |
