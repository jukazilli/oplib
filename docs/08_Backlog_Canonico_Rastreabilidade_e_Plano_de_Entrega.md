...
Estado atual: Início, Publicações e Áreas aprovados no Preview em Chromium a 320 px, sem overflow e sem violações axe WCAG A/AA no estado vazio. Conteúdo real, administração autenticada, demais breakpoints, zoom, teclado e leitor de tela permanecem pendentes.
