...
Estado atual: proveniência das mutações públicas, payload de comentários, rotas de capa, conteúdo não confiável e gate de vulnerabilidades altas/críticas cobertos localmente; a matriz restante, alertas moderados, Preview e WAF continuam pendentes.
