...
Estado atual: lista privada, box `Publique algo em seu acervo`, composição modal, menu por item e biblioteca de rascunhos implementados. Suíte local aprovada; aguarda inspeção autenticada de desktop e celular no Preview.
